 ...
 *
 * 创建日期：(2015-2-9)
 * @param newRole_id 主键值
 */
public RoleVO(String newRole_id) {
 ...
 */
public void setPrimaryKey(String newRole_id) {
...
public void validate() throws ValidationException {
	...
	if (role_name == null) {
		errFields.add(new String("role_name"));
	}
