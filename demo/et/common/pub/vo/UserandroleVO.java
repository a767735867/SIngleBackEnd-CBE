 ...
 * @author：
 */
public class UserandroleVO extends SuperVO {

	private String userandrole_id;
 ...
 *
 * 创建日期：(2015-2-9)
 * @param newUserandrole_id 主键值
 */
public UserandroleVO(String newUserandrole_id) {

	// 为主键字段赋值:
	userandrole_id = newUserandrole_id;
}
/**
...
public Object clone() {
	...
	UserandroleVO userandrole = (UserandroleVO)o;
...
public String getPrimaryKey() {
	...
	return userandrole_id;
}
/**
 * 设置对象标识，用来唯一定位对象。
 *
 * 创建日期：(2015-2-9)
 * @param newUserandrole_id String 
 */
public void setPrimaryKey(String newUserandrole_id) {

	userandrole_id = newUserandrole_id;
}
/**
 * 属性userandrole_id的Getter方法。
 *
 * 创建日期：(2015-2-9)
 * @return String
 */
public String getUserandrole_id() {
	return userandrole_id;
}
/**
 * 属性user_id的Getter方法。
...
/**
 * 属性userandrole_id的setter方法。
 *
 * 创建日期：(2015-2-9)
 * @param newUserandrole_id String
 */
public void setUserandrole_id(String newUserandrole_id) {
...
public void validate() throws ValidationException {
	...
	if (userandrole_id == null) {
		errFields.add(new String("userandrole_id"));
	}
	if (user_id == null) {
